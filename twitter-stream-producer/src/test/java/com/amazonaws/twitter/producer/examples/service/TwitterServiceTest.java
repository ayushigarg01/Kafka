...
class TwitterServiceTest {
	 ...
	 * 
	 * @Test void extractHashTagAndSendToKafka() throws Exception { subject = new
	 * TwitterService(kafkaService, httpClient);
	 * 
	 * String tweet =
	 ...
	 * ByteArrayInputStream(tweet.getBytes(StandardCharsets.UTF_8));
	 * 
	 ...
	 * 
	 * verify(response, times(1)).getEntity(); verify(kafkaService,
	 * times(1)).send("my_awesome_hashtag"); }
	 */
}
