...
class AppConfigTest {
	 ...
	 * 
	 * @BeforeEach void setUp() { subject = new AppConfig(); }
	 * 
	 * @Test void returnsConfiguredKafkaProperties() {
	 * 
	 ...
	 * props.getProperty(KEY_SERIALIZER_CLASS_CONFIG)); assertEquals(
	 * StringSerializer.class.getName(),
	 * props.getProperty(VALUE_SERIALIZER_CLASS_CONFIG)); }
	 * 
	 * @Test void returnsNonNullHttpClient() { assertNotNull(subject.httpClient());
	 * }
	 * 
	 * @Test void returnsNonNullKafkaProducer() {
