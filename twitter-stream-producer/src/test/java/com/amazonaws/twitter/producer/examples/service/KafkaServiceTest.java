...
class KafkaServiceTest {
	 ...
	 * 
	 * @Test void invokesKafkaProducerSendMethod() { subject = new
	 * KafkaService(kafkaProducer); subject.send("random message");
	 * verify(kafkaProducer, times(1)).send(any(ProducerRecord.class)); }
	 * 
	 * @Test void throwExceptionWhenKafkaProducerNull() {
